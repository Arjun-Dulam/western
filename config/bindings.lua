...
local keys = {
   ...
   -- tab: title
   { key = '9',          mods = mod.SUPER,     action = act.EmitEvent('tabs.manual-update-tab-title') },
   { key = '0',          mods = mod.SUPER,     action = act.EmitEvent('tabs.reset-tab-title') },
